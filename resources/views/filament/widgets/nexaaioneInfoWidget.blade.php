<x-filament-widgets::widget class="fi-filament-info-widget">
    <x-filament::section>
        <div class="flex items-center gap-x-3">
            <div class="flex-1">
                <a
                    href="https://github.com/mrahmadt/NexaAIOne"
                    rel="noopener noreferrer"
                    target="_blank"
                >
<span class="inline" style="font-size: 2.5rem;line-height: 2.5rem;">🧞‍♂️</span> <span class="text-2xl inline">NexaAIOne</span>
            </div>

            <div class="flex flex-col items-end gap-y-1">
                <x-filament::link
                    color="gray"
                    href="https://github.com/mrahmadt/NexaAIOne/tree/main/docs"
